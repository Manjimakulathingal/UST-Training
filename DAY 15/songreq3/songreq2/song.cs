...

{
...

    {
...

        {
            ...
            return String.Format("name::{0} artist::{1} songtype:: {2} rating::{3} numofdownloads:: {4} dateofdownload::{5}", _name, _artist, _songType, _rating, _numberOfDownloads, _dateDownloaded.ToString("dd-mm-yyyy", null));
